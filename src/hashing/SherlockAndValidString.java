...
public class SherlockAndValidString {
    ...
    public static void main(String[] args) {
        ...
        SherlockAndValidString validString = new SherlockAndValidString();

        List<String> inputs = Arrays.asList("aabbcd", "abcdeedcbae", "aabbcc", "aabbcccdd");
        inputs.forEach(input -> System.out.println(input+": "+
                validString.isValid(input)));
